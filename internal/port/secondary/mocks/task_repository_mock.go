...
import (
	model "github.com/italorfeitosa/go-ports-n-adapters/internal/core/model"
...
func (_m *TaskRepository) Insert(_a0 model.Task) error {
	ret := _m.Called(_a0)
...
func (_c *TaskRepository_Insert_Call) Run(run func(_a0 model.Task)) *TaskRepository_Insert_Call {
...
func (_c *TaskRepository_Insert_Call) RunAndReturn(run func(model.Task) error) *TaskRepository_Insert_Call {
	_c.Call.Return(run)
	return _c
}
